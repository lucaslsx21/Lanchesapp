...
var CELULAR_EMPRESA = '5527991234567';
...
cardapio.metodos = {
  ...
  verMais: () => {
    var ativo = $(".container-menu a.active").attr("id").split("menu-")[1]; // ex.: [menu-] [burgers]
  ...
  // altara os textos e exibe os botões das etapas
  carregarEtapa: (etapa) => {
    if (etapa == 1) {
  ...
  // carrega os valores de subtotal,
  carregarValores: () => {
  ...
  buscarCep: () => {
    ...
    if (cep != "") {
      ...
      // expressão regular para validade o CEP
      var validacep = /^[0-9]{8}$/;
      ...
      if (validacep.test(cep)) {
        $.getJSON("https://viacep.com.br/ws/" + cep + "/json/?callback=?", function (dados) {
          if (!("erro" in dados)) {
            ...
            $("#txtEndereco").val(dados.lagradouro);
  ...
  // carrega icone do botão Whatsapp (banner)
  carregarBotaoWhatSapp: () => {

    var  texto = 'Olá! gostaria de fazer um pedido via *whatsapp*';
    ...
    // carrega icone do botão Whatsapp (footer)
  ...
  // serve para exibir a mensagem para adicionar ao carrinho
  ...
  item: `
    <div class="col-12 col-lg-3 col-md-3 col-sm-6 mb-5 animated fadeInUp">
                                <div class="card card-item" id="\${id}">
                                    ...
                                    <p class="title-produto text-center mt4">
                                        <b>\${nome}</b>
                                    </p>
